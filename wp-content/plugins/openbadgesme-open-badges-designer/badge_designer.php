<?php
/*
Plugin Name: Open Badge Designer
Plugin URI: https://www.openbadges.me/
...
function bd_create_menu(){
	add_media_page('Badge Designer', 'Badge Designer', 'edit_posts', 'db-menu-identifier', 'badge_designer');
}
